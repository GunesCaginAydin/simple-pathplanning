...
tev = struct('vertex',{},'initial',{},'parent',{},'col',{},'mindist',{},'totcost',{},'line',{});
...
r_search = 100; % RRT* search param1 - width
c_search = 100; % RRT* search param2 - height
...
while it < il
    ...
    if goal_dist <= 50 && tev(it+1).totcost <= cost_lim
        ...
        str = sprintf(['Goal reached within a distance ' ...
